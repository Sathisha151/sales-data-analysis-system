 ...
 * @author Sathisha
 */
public class bestselligproducrs extends javax.swing.JFrame {

    /**
     
     */
    public bestselligproducrs() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bestselligproducrs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bestselligproducrs().setVisible(true);
            }
        });
    }
